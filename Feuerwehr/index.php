...
<html>
	...
	<body scroll="no" onresize="video_size()" onload="active()"><!--onscroll="scrolljump()"-->
		<header>
			<?php
		...
		<source src="./Sound/alarm.wav" type="audio/wav">
			...
			<!--<div id="main">-->
				<div class="part" id="part_1">
						...
						<video src="./Video/test2_trimm.mp4" autoplay loop muted id="title_video" ></video><!--autoplap loop muted-->
				...
				<div class="part" id="part_3">
					<div id="media_options">
						<ul class="list">			
							<a id="o_Über" class="btn active" onclick="active()"><li class="list_option" id="list_first">Über uns</li></a>
							<a id="o_Fahrzeuge" class="btn" onclick="active()"><li class="list_option">Fahrzeuge</li></a>
							<a id="o_Einsatzabteilung" class="btn" onclick="active()"><li class="list_option">Einsatzabteilung</li></a>
							<a id="o_Jugendfeuerwehr" class="btn" onclick="active()"><li class="list_option">Jugendfeuerwehr</li></a>
							<a id="o_Kinderfeuerwehr" class="btn" onclick="active()"><li class="list_option">Kinderfeuerwehr</li></a>
							<a id="o_Übungen" class="btn" onclick="active()"><li class="list_option">Übungen</li></a>
							<a id="o_Events" class="btn" onclick="active()"><li class="list_option">Events</li></a>
							<a id="o_Förderverein" class="btn" onclick="active()"><li class="list_option">Förderverein</li></a>
							<a id="o_Musikzug" class="btn" onclick="active()"><li class="list_option">Musikzug</li></a>
							<a id="o_Altersabteilung" class="btn" onclick="active()"><li class="list_option">Altersabteilung</li></a>
						</ul>
					</div>
					<script>
					function active(){
			...
			<!--</div>-->	
				...
				$("#o_Einsatzabteilung").click(function(){
					$(".media").html('<link href="./css/FF.css" rel="stylesheet" type="text/css" /><div id="Einsatzabteilung" class="media_content"><div id="FF_text">Die Einsatzabteilung der Feuerwehr Tündern kümmert sich um die Abwehr von Gefahren durch Brände sowie um die Hilfeleistung bei Unfällen und Notständen. Außerdem ist sie meißt bei Veranstaltungen im Ort vertreten und ünterstützt das Gemeinschaftsleben. Das Mindestalter zum beitreten liegt bei 16 Jahren. Ebenfalls muss der Truppmann Lehrgang erfolgreich absolviert werden.</div><div id="FF_img"><div><img src="./img/FF_1.jpg"></div><div><img src="./img/FF_2.jpg"></div><div><img src="./img/FF_3.jpg"></div></div>');
					$('link[href="./css/Fahrzeuge.css"]').prop('disabled', true);
					$('link[href="./css/Übungen.css"]').prop('disabled', true);
					$('link[href="./css/Events.css"]').prop('disabled', true);
					$('link[href="./css/JF.css"]').prop('disabled', true);
